...
#parent and long name by parentclasses
    ...
    def enterMethodDeclaration(self, ctx: JavaParserLabeled.MethodDeclarationContext):
        ...
        if(True):
            ...
            ##############
            #reversed(self.modifiers)
            # print('reversed modifiers' ,list(reversed(self.modifiers)) )
            # print('longlong' , scope_longname)
            string = ''
    ...
    def enterClassBodyDeclaration2(self, ctx:JavaParserLabeled.ClassBodyDeclaration2Context):
        ...
        # print('body ? ' , ctx.getText())
        for x in children:
            # print( 'gooogoooli magoooli naz beshi ', type(x).__name__)
    ...
    def enterTypeTypeOrVoid(self, ctx:JavaParserLabeled.TypeTypeOrVoidContext):
       if( type(ctx.parentCtx).__name__ == 'MethodDeclarationContext'):
            ...
            if(type(x).__name__ == 'TypeTypeContext'):
                    ...
                    tt = t.children[0]
                    #print(tt.getText())
                    # print('list ? Interface ? ',type(t).__name__)
            ...
            #print('MethodKind' , self.Methodkind)
            self.dic['Methodkind'] = self.Methodkind
            # self.extendedtoentity.append(self.dic)
